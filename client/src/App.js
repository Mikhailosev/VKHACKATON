...
import {
    ...
    ModalPage,
    ModalPageHeader,
    IS_PLATFORM_ANDROID, HeaderButton, IS_PLATFORM_IOS, FormLayoutGroup, Button
} from "@vkontakte/vkui";
...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    async apiRequests() {
        ...
        this.setState({token: token.data.access_token, tokenScope: token.data.scope});
  ...
  onStoryChange(e) {
    ...
    toggleModal() {
        this.state.activeModal ? this.setState({activeModal:null}) : this.setState({activeModal:'share'})
    }
        ...
        return (
            <ModalRoot activeModal={this.state.activeModal}>
                ...
                >
                    <FormLayout>
                        <FormLayoutGroup>
                            <Button level="secondary" onClick={() => this.postToWall()} size="xl">Опубликовать на стене</Button>
                            <Button level="secondary" onClick={() => this.addToStory()} size="xl">Добавить в историю</Button>
                        </FormLayoutGroup>
                    </FormLayout>
                </ModalPage>
            </ModalRoot>
